...
{
    public partial class GetCustomsBomForm : Form
    {
        ...
        public GetCustomsBomForm()
        {
            InitializeComponent();
        }

        private static GetCustomsBomForm getCustomsBomFrm;
        public static GetCustomsBomForm CreateInstance()
        {
            if (getCustomsBomFrm == null || getCustomsBomFrm.IsDisposed)
            {
                getCustomsBomFrm = new GetCustomsBomForm();
            }
