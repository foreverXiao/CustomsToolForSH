...
namespace SHCustomsSystem
{
    class ConfigSettings
    {
        ...
        public string strOPMInfo;
        public string strOracleInfo;
        public string strEssOrclInfo;
        public string strAdminMailInfo;

        public string SqlInfo
        {
            get { return strSqlInfo; }
        }
        public string OPMInfo
        {
            get { return strOPMInfo; }
        }
        public string OracleInfo
        {
            get { return strOracleInfo; }
        }
        public string EssOrclInfo
        {
            get { return strEssOrclInfo; }
        }
        public string AdminMailInfo
        {
            get { return strAdminMailInfo; }
        }
        ...
        public void ReadConfigSettings()
        {
            ...
            strDetail = strLines[0].Split(':');
            strSqlInfo = strDetail[1].ToString().Trim();

            strDetail = strLines[1].Split(':');
            strOPMInfo = strDetail[1].ToString().Trim();

            strDetail = strLines[2].Split(':');
            strOracleInfo = strDetail[1].ToString().Trim();

            strDetail = strLines[3].Split(':');
            strEssOrclInfo = strDetail[1].ToString().Trim();

            strDetail = strLines[4].Split(':');
            strAdminMailInfo = strDetail[1].ToString().Trim();
        }
    }
    ...
    public class SqlLib : IDisposable
    {
        ...
        public static string StrOPMConnection
        {
            get
            {
                ConfigSettings cs = new ConfigSettings();
        ...
        public static string StrOracleConnection
        {
            get
            {
                ConfigSettings cs = new ConfigSettings();
                cs.ReadConfigSettings();
                return cs.OracleInfo;
            }
        }

        public static string StrEssOrclConnection
        {
            get
            {
                ConfigSettings cs = new ConfigSettings();
                cs.ReadConfigSettings();
                return cs.EssOrclInfo;
            }
        }
    ...
    public class Email
    {
        public string StrAdminMail
        {
            get
            {
                ConfigSettings cs = new ConfigSettings();
                cs.ReadConfigSettings();
                return cs.AdminMailInfo;
            }
        }

        public void SendEmail(string strMailTo, string strSubject, string strBody)
        {
            string strMailFrom = "mail address in smtpserver?";
            NetworkCredential credential = new NetworkCredential("login name?", "password?");
            SmtpClient smtp = new SmtpClient("smtpserver?");
            smtp.Credentials = credential;

            MailMessage message = new MailMessage(strMailFrom, strMailTo);
